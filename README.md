# ⚙️ robosys2025 ― Shaft Section Tools  
STEP ファイルから丸シャフト（中実・中空・段付き）の  
**極断面係数 Zp** と **極二次モーメント Jp** を数値的に求めるコマンド群です。
